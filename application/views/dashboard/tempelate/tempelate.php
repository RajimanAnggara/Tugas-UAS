...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="<?php echo base_url();?>assets/js/vendors/dropzone/dropzone.js"></script>
    <link href="<?php echo base_url();?>assets/js/vendors/dropzone/dropzone.css" rel="stylesheet" />
    <!-- c3.js Charts Plugin -->
          ...
          <div class="container">
            <div class="d-flex">
              <a class="header-brand" href="<?php echo base_url();?>dashboard">
                <img src="<?php echo base_url();?>assets/img/logo.png" class="header-brand-img" alt="tabler logo"> KABUPATEN LOMBOK TENGAH
              </a>
